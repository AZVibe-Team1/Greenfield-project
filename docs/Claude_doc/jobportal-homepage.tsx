          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/register/job-seeker" className="hover:text-white transition">Create Profile</a></li>
                <li><a href="/recommendations" className="hover:text-white transition">Job Recommendations</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/register/employer" className="hover:text-white transition">Post a Job</a></li>
                <li><a href="/employer/dashboard" className="hover:text-white transition">Employer Dashboard</a></li>
                <li><a href="/employer/candidates" className="hover:text-white transition">Find Candidates</a></li>
              </ul>
            </div>
